...
OPTBL:	DW	ZERO,ADD,SUB,MUL,DIV,DIVMOD,INCR,DECR		; 00 02 04 06 08 0A 0C 0E
	...
	DW	DROP,DUP,PUSH,PULL,BRLT,BRGT,BREQ,BRNE		; 30 32 34 36 38 3A 3C 3E
	DW	ISEQ,ISNE,ISGT,ISLT,ISGE,ISLE,BRFLS,BRTRU	; 40 42 44 46 48 4A 4C 4E
	DW	SKIP,ISKIP,CALL,ICAL,ENTER,LEAVE,RET,??? 	; 50 52 54 56 58 5A 5C 5E
...
OPXTBL: DW	ZERO,ADD,SUB,MUL,DIV,DIVMOD,INCR,DECR		; 00 02 04 06 08 0A 0C 0E
	...
	DW	DROP,DUP,PUSH,PULL,BRLTX,BRGTX,BREQX,BRNEX	; 30 32 34 36 38 3A 3C 3E
	DW	ISEQ,ISNE,ISGT,ISLT,ISGE,ISLE,BRFLSX,BRTRUX	; 40 42 44 46 48 4A 4C 4E
	DW	SKIPX,ISKIPX,CALLX,ICAL,ENTER,LEAVE,RET,???	; 50 52 54 56 58 5A 5C 5E
